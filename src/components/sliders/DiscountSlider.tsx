  ...
  return (
    <>
      ...
      <section className="flex flex-col-reverse xs:flex-row  sm:hidden absolute w-full -top-24 py-2.5">
        <div className=" gap-8 flex-col bg-[#dcb6db]  z-50 items-center xs:-ml-24">
          <div className="hidden xs:block w-full h-[86px] text-center pt-6 text-lg text-gray-400 bg-white pr-10">تخفیف های وندامد</div>
          <div className="flex gap-8 flex-col pl-8  items-center pr-10">
