  ...
  return (
    <section className="mb-5 relative">
      <div className="hidden md:block">
        <div className={`transition-opacity lg:border-none border-y-2 border-[#e90089] ease-in-out duration-300 ${fade ? 'opacity-0' : 'opacity-100'}`}>
          <ResponsiveImage
        ...
        <div className="mt-5 flex lg:justify-start justify-center gap-x-5 overflow-auto">
         ...
         >
          ...
          <button
            ...
            className="bg-[#e90089] text-white rounded-full rotate-90 absolute right-6 lg:-right-5 bottom-8 z-[50]"
          >
            <ArrowDown className="text-3xl rotate-180" />
          </button>
          <button
            onClick={handleNextImage}
            className=" bg-[#e90089] text-white rounded-full rotate-90 absolute left-6 lg:z-[100] lg:-left-8 bottom-8 z-[50]"
          >
